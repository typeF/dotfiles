...
let s:p.normal.left = [ [ '#292c33', '#8C82FF', s:term_black, s:term_green, 'bold' ], [ '#8C82FF', '#292c33', s:term_green, s:term_black ] ]
let s:p.normal.right = [ [ '#292c33', '#8C82FF', s:term_black, s:term_green ], [ '#abb2bf', '#3e4452', s:term_white, s:term_grey ], [ '#8C82FF', '#292c33', s:term_green, s:term_black ] ]
" let s:p.normal.right = [ [ '#292c33', '#16AA91', s:term_black, s:term_green ], [ '#abb2bf', '#3e4452', s:term_white, s:term_grey ], [ '#16AA91', '#292c33', s:term_green, s:term_black ] ]
let s:p.inactive.right = [ [ '#292c33', '#778991', s:term_black, s:term_blue], [ '#abb2bf', '#3e4452', s:term_white, s:term_grey ] ]
let s:p.inactive.left = s:p.inactive.right[1:]
" her
let s:p.insert.left = [ [ '#292c33', '#FFCB6B', s:term_black, s:term_blue, 'bold' ], [ '#FFCB6B', '#292c33', s:term_blue, s:term_black ] ]
" let s:p.insert.left = [ [ '#292c33', '#61afef', s:term_black, s:term_blue, 'bold' ], [ '#61afef', '#292c33', s:term_blue, s:term_black ] ]
let s:p.insert.right = [ [ '#292c33', '#FFCB6B', s:term_black, s:term_blue ], [ '#ABB2BF', '#3E4452', s:term_white, s:term_grey ], [ '#FFCB6B', '#292c33', s:term_blue, s:term_black ] ]
